...
const SurketModel = {
  async createSurket(nik, nama, tempat_lahir, tanggal_lahir, alamat, agama, keperluan, user_id) {
    try {
      const result = await pool.query(
        'INSERT INTO "suket" (nik, nama, tempat_lahir, tanggal_lahir, alamat, agama, keperluan, user_id, created_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, NOW()) RETURNING *',
        [nik, nama, tempat_lahir, tanggal_lahir, alamat, agama, keperluan, user_id]
      );
